        ...
        <div className="flex flex-col items-center gap-8 px-8 py-12 max-w-[1200px] w-full">
          ...
          {isLoadingSubscription ? (
            ...
            <div className="flex flex-col items-center gap-6 w-full">
              ...
              <button
                ...
                className="w-full max-w-[27em] py-3 rounded-xl font-poppins font-semibold text-sm capitalize cursor-pointer transition-colors duration-200 text-[#61CB08]"
                style={{
                  background: '#113D00',
                  border: '1px solid rgba(97, 203, 8, 0.32)'
                }}
          ...
          {!subscriptionDetails || subscriptionDetails.status !== 'active' ? (
            ...
            <button
              type="button"
              onClick={handleLogout}
              className="w-[30em] py-3 rounded-[14px] font-poppins font-semibold text-sm capitalize cursor-pointer transition-colors duration-200 bg-[#113D00] text-white hover:bg-[#016606]"
            >
              Logout
            </button>
        </div>
