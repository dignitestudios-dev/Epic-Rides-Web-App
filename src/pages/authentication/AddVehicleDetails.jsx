              ...
              <div className="flex flex-col items-start gap-3 md:gap-4 w-full">
                ...
                <div className="flex flex-col items-start gap-1 w-full">
                  ...
                  <input
                    ...
                    className="custom-date-picker w-full px-3 md:px-4 pr-10 py-2 md:py-2.5 rounded-xl outline-none placeholder:text-[#808080] font-poppins text-xs md:text-sm h-10 md:h-[44px]"
                    style={{
                      background: 'linear-gradient(180deg, rgba(97, 203, 8, 0.12) 0%, rgba(97, 203, 8, 0.04) 50%, rgba(97, 203, 8, 0.07) 100%)',
                      backdropFilter: 'blur(42px)',
