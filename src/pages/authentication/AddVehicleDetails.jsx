...
const AddVehicleDetails = () => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // If upload successful, navigate to Verified Account page
      if (result?.message) {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {/* Main Content */}
      <div className="absolute inset-0 flex items-center justify-center md:justify-end overflow-y-auto max-h-[50em] pt-[24em] md:pt-0">
        <div className="w-full max-w-[calc(100%-2rem)] md:!w-[75em] flex flex-col items-center justify-center md:pr-[0em] py-6 md:py-8 px-4 md:px-0">
          {/* Header */}
          ...
          {/* Form Container */}
          <div className="flex flex-col md:flex-row items-start gap-3 md:gap-[14px] mb-0 w-full md:w-[746px] md:h-[409px]">
            {/* Left Column */}
                ...
                <div className="flex flex-col items-start gap-1 flex-1">
                  <div className="flex flex-row justify-center items-center gap-1">
                    ...
                    <div className="w-3 h-3 md:w-3.5 md:h-3.5 rounded-full bg-[#61CB08] flex items-center justify-center">
                      <Info size={8} color="#000B00" strokeWidth={2.5} className="md:w-2.5 md:h-2.5" />
                    </div>
                  </div>
                  <input
                    type="text"
